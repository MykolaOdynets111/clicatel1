    ...
    public Map<String, Object> verifyAndUpdateChatSettings(String type) {
        ...
        if (!type.equalsIgnoreCase("ticket")) {
            if (supportHours.get(0).getDays().size() < 7
                ...
                ResponseBody resp = ApiHelperSupportHours.setSupportDaysAndHours(Tenants.getTenantUnderTestOrgName(), "all week", "00:00", "23:59");
                supportHoursUpdated = resp.as(GeneralSupportHoursItem.class).getAgentMapping();
