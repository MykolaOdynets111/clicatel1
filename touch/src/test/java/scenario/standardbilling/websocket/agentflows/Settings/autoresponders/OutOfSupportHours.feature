...
Feature: Dashboard: Settings: Auto Responder
  ...
  @remove_dep
  @support_hours
  Scenario: CD :: Dashboard :: Settings :: Auto Responder :: Verify that user should receive "out of support hours" autoresponder message when user try to reach out of specific support hours per department time
