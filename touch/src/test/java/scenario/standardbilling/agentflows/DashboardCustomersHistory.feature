Feature: Dashboard: Customer History
  ...
  Scenario: Dashboard: Verify if admin can filter Customers History report by channel and period
    ...
    And Admin click on Customers Overview dashboard tab
    And Admin click on Customers History on dashboard
    And Admin filter Customers History by WhatsApp channel and Past day period
    Then Admin see all graphs filtered by WhatsApp channel and Past day period
    And Admin filter Customers History by WhatsApp channel and Past 2 weeks period
    Then Admin see all graphs filtered by WhatsApp channel and Past 2 weeks period
    ...
    And Admin filter Customers History by WhatsApp channel and Past 4 weeks period
    Then Admin see all graphs filtered by WhatsApp channel and Past 4 weeks period
    And Admin filter Customers History by Apple Business Chat channel and Past week period
    Then Admin see all graphs filtered by Apple Business Chat channel and Past week period
    And Admin filter Customers History by Apple Business Chat channel and Past 2 weeks period
    Then Admin see all graphs filtered by Apple Business Chat channel and Past 2 weeks period
    And Admin filter Customers History by Apple Business Chat channel and Past 3 weeks period
    Then Admin see all graphs filtered by Apple Business Chat channel and Past 3 weeks period
    ...
    And Admin filter Customers History by SMS channel and Past week period
    Then Admin see all graphs filtered by SMS channel and Past week period
    And Admin filter Customers History by SMS channel and Past 2 weeks period
    Then Admin see all graphs filtered by SMS channel and Past 2 weeks period
    And Admin filter Customers History by SMS channel and Past 3 weeks period
    Then Admin see all graphs filtered by SMS channel and Past 3 weeks period
    And Admin filter Customers History by SMS channel and Past 4 weeks period
    Then Admin see all graphs filtered by SMS channel and Past 4 weeks period
