...
Feature: User should be able to continue chat
  ...
  Scenario: User should be able to continue conversation after first message
    ...
    Then User have to receive 'Checking your balance on your phone is easy. You'll need to download and register the General bank app. Then, select save, sign in and voila, you'll be able to see your balances.' text response for his 'account balance' input
