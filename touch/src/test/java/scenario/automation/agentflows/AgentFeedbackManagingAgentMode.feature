...
Feature: Turning on / off AGENT_FEEDBACK feature for Agent mode tenant
  ...
  Scenario: Turning off 'Additional Agent Notes to Closed Chat' feature (Agent mode tenant)
  ...
  Scenario: Turning on 'Additional Agent Notes to Closed Chat' feature (Agent mode tenant)
