...
public class ListTenantBusinessHoursResponse {
  ...
  public ListTenantBusinessHoursResponse businessHours(List<BusinessHourResponse> businessHours) {
    this.businessHours = businessHours;
    return this;
  }

  public ListTenantBusinessHoursResponse addBusinessHoursItem(BusinessHourResponse businessHoursItem) {
