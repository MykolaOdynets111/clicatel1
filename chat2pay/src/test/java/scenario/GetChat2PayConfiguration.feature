...
#This API returns the configuration data for the configured Chat 2 Pay product.
  ...
  Scenario Outline: c2p-Widget-Payment-Service :: GET /config :: Get Chat 2 Pay configuration
    ...
    Examples:
      ...
      | c80a79a9857040acafbea2774008ed1b | 200            | false                    | true                | c80a79a9857040acafbea2774008ed1b | 156                    | ZAR                       | South African rand         | R                            | true                            | SANDBOX       | 4562605b-28b4-466f-b2e4-fd67df78c816 | Test               | ACTIVATED            | APPLICATION        |              |                |
