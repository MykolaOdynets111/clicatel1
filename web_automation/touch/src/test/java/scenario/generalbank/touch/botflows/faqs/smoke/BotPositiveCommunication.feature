...
Feature: General Bank POSITIVE flow
  ...
  Scenario Outline: Verify if user receives correct answer on "<user input>" message
    ...
    Examples:
      | user input                                                    |expected response|
      |trading hours                                                  |Hi ${firstName}. Selected branches in major shopping malls are open on Sundays (9am - 1pm or 10am - 2pm). You may visit to check the trading hours of your nearest branch. Use the cellphone banking app to do transactions 24/7. For more information on #TheBestWaytoBank you may visit us|
      |Are you open on weekends?                                      |Hi ${firstName}. Selected branches in major shopping malls are open on Sundays (9am - 1pm or 10am - 2pm). You may visit to check the trading hours of your nearest branch. Use the cellphone banking app to do transactions 24/7. For more information on #TheBestWaytoBank you may visit us                                                                                                                                                                                                    |
