...
Feature: TIE should correctly identify intents for messages with spelling mistakes
  ...
  Scenario: Verify if TIE correctly identifies "hello" intent from following message: "hellow"
    Then TIE returns 1 intent: "hello" on 'hellow' for General Bank Demo tenant
