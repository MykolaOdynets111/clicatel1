...
public interface JSHelper extends WebActions{
    ...
    default boolean wheelScrollUpToElement(WebDriver driver, WebElement scrolArea, WebElement element, int waitTime){
        for (int i=0; i<4; i++)  {
            if(isElementShown(driver, element, waitTime)){
                return true;
            }
            wheelScroll(driver, scrolArea, -200, 0,0);
        }
    ...
    default boolean wheelScrollDownToElement(WebDriver driver, WebElement scrolArea, WebElement element, int waitTime){
        for (int i=0; i<4; i++)  {
            if(isElementShown(driver, element, waitTime)){
                return true;
            }
