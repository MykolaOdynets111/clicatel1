...
public enum DBProperties {
    ...
    TESTING_TOUCH("testing", "touch", "touch_testing", "touch_testing", "testing_touch_platform", "jdbc:mysql://agentflows-db-testing.clickatelllabs.com:3306/testing_touch_platform?characterEncoding=UTF-8&useUnicode=yes&autoReconnect=true"),
    ...
    INTEGRATION_TOUCH("integration", "touch", "touch_int", "touch_int", "integration_touch_platform", "jdbc:mysql://agentflows-db-integration.clickatelllabs.com:3306/integration_touch_platform?characterEncoding=UTF-8&useUnicode=yes&autoReconnect=true"),

    DEV_TOUCH("dev", "touch", "touch_dev", "touch_dev", "dev_touch_platform", "jdbc:mysql://agentflows-db-dev.clickatelllabs.com:3306/dev_touch_platform?characterEncoding=UTF-8&useUnicode=yes&autoReconnect=true"),
    ...
    QA_TOUCH("qa", "touch", "touch_qa", "touch_qa", "qa_touch_platform", "jdbc:mysql://agentflows-db-qa.clickatelllabs.com:3306/qa_touch_platform?characterEncoding=UTF-8&useUnicode=yes&autoReconnect=true"),
    ...
    DEMO_TOUCH("demo", "touch", "touch_demo", "touch_demo", "demo_touch_platform", "jdbc:mysql://agentflows-db-demo.clickatelllabs.com:3306/demo_touch_platform?characterEncoding=UTF-8&useUnicode=yes&autoReconnect=true"),
