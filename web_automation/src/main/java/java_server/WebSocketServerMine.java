...
//
//public class WebSocketServerMine extends AbstractWebSocket implements Runnable{
//
...
//
//    protected List<org.java_websocket.server.WebSocketServer.WebSocketWorker> decoders;
//
...
//     *
//     * @see #WebSocketServerMine(InetSocketAddress, int, List, Collection) more details here
//     */
//    public WebSocketServerMine()  {
...
//     */
//    public WebSocketServerMine( InetSocketAddress address ) {
...
//     * @param decodercount
//     *            The number of {@link org.java_websocket.server.WebSocketServer.WebSocketWorker}s that will be used to process the incoming network data. By default this will be <code>Runtime.getRuntime().availableProcessors()</code>
//     */
//    public WebSocketServerMine( InetSocketAddress address , int decodercount ) {
...
//     *
//     */
//    public WebSocketServerMine( InetSocketAddress address , List<Draft> drafts ) {
...
//
//     */
//    public WebSocketServerMine( InetSocketAddress address , int decodercount , List<Draft> drafts ) {
...
//     */
//    public WebSocketServerMine( InetSocketAddress address , int decodercount , List<Draft> drafts , Collection<WebSocket> connectionscontainer ) {
...
//
//        decoders = new ArrayList<org.java_websocket.server.WebSocketServer.WebSocketWorker>( decodercount );
//        buffers = new LinkedBlockingQueue<ByteBuffer>();
//        for( int i = 0 ; i < decodercount ; i++ ) {
//            org.java_websocket.server.WebSocketServer.WebSocketWorker ex = new org.java_websocket.server.WebSocketServer.WebSocketWorker();
//            decoders.add( ex );
//            ex.start();
//        }
//    }
...
//            if( decoders != null ) {
//                for( WebSocketServer.WebSocketWorker w : decoders ) {
//                    w.interrupt();
//                }
//            }
//            if( selector != null ) {
