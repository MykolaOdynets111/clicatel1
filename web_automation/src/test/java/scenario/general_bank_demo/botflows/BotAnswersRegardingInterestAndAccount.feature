...
Feature: Bot answers regarding interest and account
  ...
  Scenario Outline: Verify if user receives answer on "<user input>" message
    ...
    Examples:
      ...
      |Why don't you offer business accounts?            |Hi ${firstName}, we only offer accounts for Personal Banking; you can visit us for more info regarding our Personal Banking offering.                                                                                                                                                                                                                                                                                                                                          |
