Feature: Chat console: Inbox tab
  ...
  Scenario: Supervisor inbox :: Verify that unassigned chats selected by default when a supervisor open an inbox
    Given I open portal
    And Login into portal as an admin of General Bank Demo account
    When I select Touch in left menu and Chat console in submenu
    And Select "Inbox" in nav menu
    Then Filter "Unassigned" is selected by default
