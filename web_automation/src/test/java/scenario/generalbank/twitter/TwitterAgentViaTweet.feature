...
Feature: Communication with agent via tweet
  ...
  Scenario: Receiving answer on tweet from the agent
    ...
    Then Conversation area becomes active with connect to agent message from twitter user
    ...
    Then User have to receive please check out our web site agent response as comment for connect to agent tweet
