...
Feature: Communication with bot via messages
  ...
  Scenario: Bot answers on user messages
    ...
    Then User have to receive correct response "Hi Tom. Checking your balance on your phone is easy. You'll need to download and register the General bank app. Then, select save, sign in and voila, you'll be able to see your balances." on his message "account balance"
