Feature: Quote request Funeral insurance flow
  ...
  Scenario:  Quote request -> Funeral Insurance, not South Africa citizen flow
    ...
    When User click Funeral insurance button in the card on user message personal info
    Then Card with a For the next step we need to confirm a few things: text is shown after user Funeral insurance input
    Then Text 'Have you ever been sequestrated or liquidated (meaning the court has had to sell your stuff to pay off your debts)?' is shown above the buttons in the card on user Funeral insurance input above
    And Card with a buttons Yes; No is shown on user Funeral insurance message
    When User click No button in the card on user message Funeral insurance
  ...
  Scenario:  Quote request -> Funeral Insurance, South Africa citizen flow
    When User enter Quote Request into widget input field
    Then Card with a Hi ${firstName}. Sure! Please, tell us who we are chatting to? text is shown on user Quote Request message
    When User submit card with personal information after user's message: Quote Request
    Then Card with a Hi ${firstName_qr}. Would you like a quote on car or funeral insurance? text is shown after user personal info input
  ...
  Scenario:  Quote request -> Funeral Insurance, more than 3 claims in the past 12 months flow
    When User enter Quote request into widget input field
    Then Card with a Hi ${firstName_qr}. Hi ${firstName}. Sure! Please, tell us who we are chatting to? text is shown on user Quote request message
    When User submit card with personal information after user's message: Quote request
  ...
  Scenario:  Quote request -> Funeral Insurance, sequestrated or liquidated flow
    When User enter quote request into widget input field
    Then Card with a Hi ${firstName}. Sure! Please, tell us who we are chatting to? text is shown on user quote request message
    When User submit card with personal information after user's message: quote request
    Then Card with a Hi ${firstName_qr}. Would you like a quote on car or funeral insurance? text is shown after user personal info input
    ...
    Then Text 'Have you ever been sequestrated or liquidated (meaning the court has had to sell your stuff to pay off your debts)?' is shown above the buttons in the card on user Funeral insurance input above
    And Card with a buttons Yes; No is shown on user Funeral insurance message
    When User click Yes button in the card on user message Funeral insurance
    Then User have to receive 'Sorry you are not eligible for a quote. Please call us on 0861 50 6070 for more info' text response for his 'Yes' input
