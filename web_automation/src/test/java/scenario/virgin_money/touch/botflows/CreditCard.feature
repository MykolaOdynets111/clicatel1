...
#    Then User have to receive 'Hi ${firstName}, did you know you can apply for a card online by clicking on the link below and then clicking 'apply now'. https://www.virginmoney.co.za/credit-card/' text response for his '<user message>' input
    Then User have to receive 'Did you know you can apply for a card online by clicking on the link below and then clicking 'apply now'. https://www.virginmoney.co.za/credit-card/' text response for his '<user message>' input
    Examples:
      |user message            |
