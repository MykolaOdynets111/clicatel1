...
#  Background:
  ...
  Scenario Outline: Sending message to .Control (to agent) using <adapter> adapter
    ...
    Examples:
      ...
      |fbmsg                                               |Hate your banking. Hello from fbmsg    |negativ|
      |whatsapp                                            |Hello from whatsapp |positiv|
      |fbpost                                              |Hello from fbpost   |positiv|
      |twdm                                                |Hello from twdm     |positiv|
      |twmention                                           |Like from twmention|neutral|
